...
public class FhirQuestionnaireDaoImplTest extends BaseModuleContextSensitiveTest {
	...
	private static final Integer FORM_RESOURCE_2_ID = 2;
	
	private static final String FORM_RESOURCE_2_UUID = "504c83c7-cfbf-4ae7-a4da-bdfa32366891";
	
	private static final String QUESTIONNAIRE_SEARCH_DATA_FILES = "org/openmrs/module/fhir2extension/api/dao/impl/FhirQuestionnaireDaoImplTest_initial_data.xml";
	...
	public void getQuestionnaireById_shouldRetrieveQuestionnaireById() {
		...
		assertThat(result.getUuid(), equalTo(FORM_RESOURCE_2_UUID));
		assertThat(result.getId(), equalTo(FORM_RESOURCE_2_ID));
	}
    ...
    public void getQuestionnaireById_shouldRetrieveQuestionnaireByIds() {
        ...
        assertThat(result.get(0).getUuid(), equalTo(FORM_RESOURCE_2_UUID));
        assertThat(result.get(0).getId(), equalTo(FORM_RESOURCE_2_ID));
    }
